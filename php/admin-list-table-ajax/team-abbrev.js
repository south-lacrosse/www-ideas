(function ($) {
	list = {
		...
		init: function () {
			...
			$('.tablenav-pages a, .manage-column.sortable a, .manage-column.sorted a').on(
				'click',
				function (e) {
					...
					var data = {
						...
						orderby: list.__query(query, 'orderby') || 'team', // TODO: CUSTOM FIELD
					};
					list.update(data);
				}
			);
			...
			$('input[name=paged]').on('keyup', function (e) {
				...
				var data = {
					...
					orderby: $('input[name=orderby]').val() || 'team', // TODO: CUSTOM FIELD
				};
		...
		update: function (data) {
			$.ajax({
				...
				data: $.extend(
					{
						_ajax_team_abbrev_list_nonce: $('#_ajax_team_abbrev_list_nonce').val(), // TODO: CUSTOM NAME
						action: '_ajax_fetch_team_abbrev_list', // TODO: CUSTOM NAME
					},
					data
				),
